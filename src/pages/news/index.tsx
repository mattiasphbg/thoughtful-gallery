      ...
      <div className="container max-w-5xl mx-auto px-4 md:px-6 lg:px-8">
        ...
        <div className="mt-6 grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-3">
          <div className="flex flex-col items-start space-y-4">
            ...
            <p className="text-zinc-500">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Integer nec odio.</p>
        ...
        <form className="mt-10 flex space-x-4">
          <Input className="flex-1" placeholder="Subscribe for more updates" type="email" />
